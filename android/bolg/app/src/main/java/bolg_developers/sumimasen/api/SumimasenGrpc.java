...
public final class SumimasenGrpc {
  ...
  public static final String SERVICE_NAME = "api.Sumimasen";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<bolg_developers.sumimasen.api.SumimasenRequest,
      bolg_developers.sumimasen.api.SumimasenResponse> getSumimasenMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Sumimasen",
      requestType = bolg_developers.sumimasen.api.SumimasenRequest.class,
      responseType = bolg_developers.sumimasen.api.SumimasenResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bolg_developers.sumimasen.api.SumimasenRequest,
      bolg_developers.sumimasen.api.SumimasenResponse> getSumimasenMethod() {
    io.grpc.MethodDescriptor<bolg_developers.sumimasen.api.SumimasenRequest, bolg_developers.sumimasen.api.SumimasenResponse> getSumimasenMethod;
      ...
      synchronized (SumimasenGrpc.class) {
        if ((getSumimasenMethod = SumimasenGrpc.getSumimasenMethod) == null) {
          SumimasenGrpc.getSumimasenMethod = getSumimasenMethod = 
              io.grpc.MethodDescriptor.<bolg_developers.sumimasen.api.SumimasenRequest, bolg_developers.sumimasen.api.SumimasenResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "api.Sumimasen", "Sumimasen"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  bolg_developers.sumimasen.api.SumimasenRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  bolg_developers.sumimasen.api.SumimasenResponse.getDefaultInstance()))
                  .build();
          }
        }
     }
  ...
  public static abstract class SumimasenImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sumimasen(bolg_developers.sumimasen.api.SumimasenRequest request,
        io.grpc.stub.StreamObserver<bolg_developers.sumimasen.api.SumimasenResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                bolg_developers.sumimasen.api.SumimasenRequest,
                bolg_developers.sumimasen.api.SumimasenResponse>(
  ...
  public static final class SumimasenBlockingStub extends io.grpc.stub.AbstractStub<SumimasenBlockingStub> {
    ...
    /**
     */
    public bolg_developers.sumimasen.api.SumimasenResponse sumimasen(bolg_developers.sumimasen.api.SumimasenRequest request) {
  ...
  public static final class SumimasenFutureStub extends io.grpc.stub.AbstractStub<SumimasenFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bolg_developers.sumimasen.api.SumimasenResponse> sumimasen(
        bolg_developers.sumimasen.api.SumimasenRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUMIMASEN:
          serviceImpl.sumimasen((bolg_developers.sumimasen.api.SumimasenRequest) request,
              (io.grpc.stub.StreamObserver<bolg_developers.sumimasen.api.SumimasenResponse>) responseObserver);
          break;
        default:
